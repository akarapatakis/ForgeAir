...
namespace ForgeAir.Playout.Views
{
    ...
    public partial class ImportFolder : HandyControl.Controls.GlowWindow
    {
        ...
        private readonly Repository<Artist> artistsService;
        private readonly Repository<ArtistTrack> artistTracksService;
        private readonly Repository<Track> tracksService;
        private readonly TrackImporter trackImporter = new TrackImporter();

        public ImportFolder()
        {
            artistsService = new Repository<Artist>(factory);
            artistTracksService = new Repository<ArtistTrack>(factory);
            tracksService = new Repository<Track>(factory);
