...
namespace ForgeAir.Core.Services.Importers.Migrators
{
    public static class JZRadio2TagMigrator
    {
        ...
        public static List<Artist> GenerateArtistFromInfoTag(string infoTag)
        {

            List<Artist> artistList = new List<Artist>() { };  

            // example string: Jazler 2.0.x InfoTag Radio Automation (www.jazler.com) |AMARYLLIS|-|S'AGAPAO|TA KALHTERA|TA KALHTERA|TA KALHTERA|OLA|OLA|True|260,0088|0|255,062|6/1/1900|F:\TRAGOYDIA\AMARYLLIS 2008\S'AGAPAO.mp3||1|1|False|2,059|False|3915|-|-|0|NotEntered||0||80||-|NotEntered|0|||0|0||27/8/2008 5:05:22 ìì|27/8/2008 6:29:22 ðì|False||False|False|13/7/2008 5:23:46 ìì|13/7/2008 5:23:46 ìì|
