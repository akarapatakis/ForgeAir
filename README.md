...
<h2>🚧 Due to my Panhellenic exams, I am currently unable to develop ForgeAir actively. </h2>

**ForgeAir** is a modern, modular and lightweight radio automation system built with C# and WPF. Designed for my use case mainly but that does not limit you in choosing ForgeAir.

---

## ✨ Features

- 🎵 High-performance audio engines (BASS & NAudio) with VST Plugins (limited to BASS only) with support for WaveOut, DirectSound and WASAPI (ASIO support only on NAudio)
...
- You need to create an account to [WeatherAPI](https://www.weatherapi.com/) in order to make use of the temperature feature in ForgeAir
- You must provide your own BASS libraries from  [Un4Seen Developments](https://www.un4seen.com/) provided you have already a commercial license bought
